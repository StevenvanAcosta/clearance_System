        ...
        <div className="w-full">
            <header className="flex justify-between items-center h-16 bg-[#25632D] text-white px-6">
                ...
                <nav className="flex items-center gap-6">
                    <Link className="hover:text-yellow-400 font-semibold" to="/accountingclerk/approved">Approved</Link>
                    <Link className="hover:text-yellow-400 font-semibold" to="/accountingclerk/student">Student</Link>
                    ...
                    <div className="relative" ref={dropdownRef}>
                        ...
                        {dropdownOpen && (
                            <div className="absolute right-0 mt-2 w-40 bg-white text-black rounded shadow-lg z-10">
                                <Link className="block px-4 py-2 hover:bg-gray-200" to="/accountingclerk/profile">
                                    Profile
                                </Link>
                                <button
...
export default AccountingClerkHeader;
